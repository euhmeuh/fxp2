...
class Gauge(Fxp.Image):
    def __init__(self, name):
        ...
        # load text
        self.life_text = Fxp.Label("label_life", "{}%"
                                   .format(int(self.life_amount * 100)),
                                   Fxp.PALETTE.get_rgb("White", "light"),
                                   Fxp.PALETTE.get_rgb("Black", "medium"))
        self.life_text.set_pos((7, 4))

        self.mana_text = Fxp.Label("label_mana", "{}%"
                                   .format(int(self.life_amount * 100)),
                                   Fxp.PALETTE.get_rgb("White", "light"),
                                   Fxp.PALETTE.get_rgb("Black", "medium"))
...
class View:
    def __init__(self, model, size, scale_mode=None, fullscreen=False):
        ...
        # color palette
        Fxp.PALETTE = self.model.get_palette(
            "packages/Manafia/palettes/rilouw.pal")
    ...
    def load_game(self):
        ...
        horizon.load_from_solid_color(Fxp.PALETTE.get_rgb("Cyan", "light"),
                                      self.get_size())
        ...
        button_disconnect = Fxp.Button("button_disconnect", text_disconnect,
                                       "Orange")
    ...
    def refresh(self):
        ...
        if fps:
            fps.set_text(str(self.clock.get_fps()))
